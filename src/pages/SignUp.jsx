        ...
        <>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2  min-h-screen'>
               ...
               <div className='flex flex-col items-center justify-center bg-brand2 py-6 lg:py-0'>
                    ...
                    <p className='text-lg mt-2 max-w-lg'>Welcome to gymskii, we are excited to have you! Enter some information to get started in your progressive overload journey :)</p>
                    <h2 className='text-2xl mt-4 font-semibold'>Already have an account?</h2>
                    <p className='mt-2'>Click "Sign in" below to log into your existing account</p>
                    <NavLink  to = "/sign-in" className = "px-8 py-2 bg-brand text-white text-lg rounded-lg mt-2 font-semibold">Sign in</NavLink>
               </div>
               {/* Right Side */}
