        ...
        <>
            ...
            <div className="max-w-4xl flex flex-col mx-auto gap-8 mt-8 px-4 md:px-0">
                <div className="flex flex-col gap-2">
                        <h2 className=" text-2xl md:text-3xl font-semibold text-brandHeading">And the studies reveal!</h2>
                        <div className="flex flex-col gap-2">
                            <p className="text-base">Most studies reveal a higher amount of protein intake is beneficial for muscle gain. However, even with these studies, 
                            ...
                            per kg(0.64 to 0.91 grams per lb) of body weight to optimize muscle gain. This recommendation aligns with the 
                            ...
                            <p className="text-base">This number should be evaluated and personalized based on your goals and current 
