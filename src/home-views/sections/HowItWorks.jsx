    ...
    return(
        <>
            ...
            <div className="px-6 py-10">
                {/* Title */}
                <h5 className = "text-xl text-stats font-semibold text-center mb-2">HOW DOES GYMSKII WORK?</h5>
                <h2 className="text-4xl text-brandHeading font-bold text-center mb-6">Three steps to smarter tracking </h2>
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-6">
                    ...
                    <div className="flex flex-col items-center gap-5 max-w-lg p-8">
                        ...
                        <h3 className="text-3xl font-medium text-stats">Crush a Workout</h3>
                    ...
                    <div className="flex flex-col items-center justify-center gap-5 max-w-lg p-8">
                        ...
                        <h3 className="text-3xl font-medium text-stats">Enter your PRs</h3>
                    ...
                    <div className="flex flex-col items-center justify-center gap-5 max-w-lg p-8">
                        ...
                        <h3 className="text-3xl font-medium text-stats">View your visuals</h3>
                ...
                <div className="flex flex-col items-center gap-6">
                    <h4 className="text-3xl font-semibold text-brandHeading">Ready for some gains?</h4>
                    <NavLink 
                    to="/sign-up" 
